...
cls6440Calibration::cls6440Calibration(QWidget *parent) :
    QDialog(parent)
{
    setupUi(this);
...
void cls6440Calibration::readSettings()
{
...
void cls6440Calibration::saveSettings()
{
    clsSettings settings;
    QString strNode =QString("MeterMode-%1/").arg(clsRS::getInst().instrumentModel);
...
void cls6440Calibration::on_btnClose_clicked()
{
    this->saveSettings();
...
void cls6440Calibration::on_btnOpen10kHz_clicked()
{
    lblOpen10kHz->setText(openTrim(2,16));
}

void cls6440Calibration::on_btnOpen100kHz_clicked()
{
    lblOpen100kHz->setText(openTrim(3,19));
}

void cls6440Calibration::on_btnOpenAllFreq_clicked()
{
    if(clsRS::getInst().instrumentModel.contains("30"))
...
void cls6440Calibration::on_btnShortSpot_clicked()
{
    lblShortSpot->setText(shortTrim(1,5));
}

void cls6440Calibration::on_btnShort10kHz_clicked()
{
    lblShort10kHz->setText(shortTrim(2,10));
}

void cls6440Calibration::on_btnShort100kHZ_clicked()
{
    lblShort100kHz->setText(shortTrim(3,10));
}

void cls6440Calibration::on_btnShortAllFreq_clicked()
{
    lblShortAllFreq->setText(shortTrim(4,13));
}

void cls6440Calibration::on_btnHF_clicked()
{
...
bool cls6440Calibration::PopUpmessage(QString strMessage,QString strTitle)
{
...
void cls6440Calibration::Increase()
{
    int i = dial->value();
...
void cls6440Calibration::sleepMs(int svalue)
{
...
bool cls6440Calibration::getCalibrationRes()
{
...
void cls6440Calibration::DelaySec(int value)
{
