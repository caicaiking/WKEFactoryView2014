#ifndef CLS6500MULTIMETERMODE_H
#define CLS6500MULTIMETERMODE_H


#include "clsMultiModeMeter.h"
#include "clsMeterLimit.h"
class cls6500MultiMeterMode : public clsMultiModeMeter
{
public:
    cls6500MultiMeterMode();
